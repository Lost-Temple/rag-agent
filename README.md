...
### 2. 上传文档
上传文档后，切分文档后，文档片段存向量库，文档关系和元数据存图数据库；
...
```
### 3. 获取文档摘要列表
文档摘要是使用LLM递归对文档全文进行摘要，直到达到长度要求，长度和递归次数可以配置。
这个文档摘要是存在关系型数据库中的，从关系型数据库中获取，分页查询
```shell
...
### 4. 使用Ollama进行问答
通过API进行问答，返回的结果中是在向量库中检索到的内容，有向量相似度打分，重排打分，以及内容所属原文档的元数据。
可以根据原文档的元数据，进行后续的文档摘要查询。
...
```shell
curl -X 'GET' \
  'http://localhost:8009/documents/cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2' \
  -H 'accept: application/json'
```
ressponse:
```json
{
  "doc_id": "cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2",
  "metadata": {
    "original_file_path": "./data/original_documents/cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2/特朗普的新闻.md",
    "filename": "特朗普的新闻.md",
    "content_type": "text/markdown",
    "doc_id": "cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2",
    "doc_dir": "./data/original_documents/cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2"
  },
  "chunks": [
    {
      "chunk_index": 1,
      "chunk_id": "cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2_chunk_1",
      "content": "特朗普签署行政令，支持煤炭行业\n\n特朗普签署行政令，旨在支持煤炭生产，尽管全球正在努力减少碳排放。 ￼\n\n请注意，以上信息均来自2025年4月9日的报道，具体细节请参考相应的新闻来源。"
    },
    {
      "chunk_index": 0,
      "chunk_id": "cb4eb432-bfa7-47bf-ab1a-abe74e5ebbc2_chunk_0",
      "content": "以下是近期与唐纳德·特朗普相关的新闻整理，供您参考：\n\n特朗普暂缓部分关税，引发市场反弹\n\n2025年4月9日，特朗普总统宣布对多个国家的新关税将暂时降低，引发全球股市大幅上涨。 ￼\n\n特朗普签署命令撤销两名前官员的安全许可\n\n同日，特朗普签署总统令，撤销了前网络安全主管克里斯托弗·克雷布斯和前国土安全部官员迈尔斯·泰勒的安全许可，两人此前曾公开批评特朗普。 ￼\n\n上诉法院支持特朗普，允许解雇数千名联邦雇员\n\n美国上诉法院裁定，允许特朗普政府继续解雇约25,000名试用期联邦雇员，此前下级法院曾要求恢复这些雇员的职位。 ￼\n\n众议院通过法案限制法官阻止特朗普议程的权力\n\n共和党主导的众议院以219票对213票通过了《无恶意裁决法案》，旨在限制法官发布针对政府政策的全国性禁令。 ￼\n\n特朗普签署行政令，旨在振兴美国造船业\n\n特朗普总统签署行政令，旨在重振美国造船业，并减少中国在全球航运业的影响力。 ￼\n\n特朗普计划取消淋浴用水限制\n\n特朗普签署命令，取消对淋浴用水压力的限制，称此举旨在“让美国的淋浴再次伟大”。 ￼\n\n特朗普签署行政令，支持煤炭行业"
    }
  ],
  "summary": "摘要：2025年4月9日，特朗普总统宣布暂缓部分关税，引发市场积极反应；同时签署多项行政令和命令，包括撤销批评他的前官员的安全许可、允许解雇联邦试用期雇员、通过限制法官禁令权力的法案等。此外，他还签署了旨在振兴美国造船业、取消淋浴用水压力限制以及支持煤炭行业的行政令。这些举措反映了特朗普政府在经济政策和社会议题上的立场和行动。"
}
```
